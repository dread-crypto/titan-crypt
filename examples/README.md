# Kraken-Crypt Examples

This directory contains practical examples demonstrating the key features of the Kraken-Crypt cryptographic library.
...
These examples show how to integrate Kraken-Crypt into:
...
For more information, see the main [README.md](../README.md) and [API documentation](../pkg/titan-crypt/).
