...
// This package implements BFieldCodec equivalent to twenty-first's BFieldCodec.
//
...
// in a format compatible with Neptune Core and other Triton VM components.
//
// Key Features:
...
//
// Reference: https://github.com/Neptune-Crypto/twenty-first/blob/master/twenty-first/src/math/bfield_codec.rs
package bfieldcodec
...
// Based on twenty-first's Vec<T> BFieldCodec implementation:
...
// Based on twenty-first's Option<T> BFieldCodec implementation:
...
// Based on twenty-first's array BFieldCodec implementation (arrays have no length prefix):
