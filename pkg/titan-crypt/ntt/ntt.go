...
//
// This is equivalent to twenty-first's ntt() function.
//
// Panics if:
...
// The input slice length must be a power of 2.
//
// This is equivalent to twenty-first's intt() function.
//
// Panics if:
// - len(x) is not a power of 2
// - len(x) > 2^31
...
//
// This is equivalent to twenty-first's ntt_unchecked().
...
//
// This is equivalent to twenty-first's swap_indices().
...
// This is equivalent to twenty-first's bitreverse().
