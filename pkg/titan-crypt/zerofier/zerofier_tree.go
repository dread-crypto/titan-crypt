...
// This package implements ZerofierTree equivalent to twenty-first's ZerofierTree.
//
...
//
// Reference: https://github.com/Neptune-Crypto/twenty-first/blob/master/twenty-first/src/math/zerofier_tree.rs
package zerofier
...
// This is equivalent to twenty-first's ZerofierTree enum.
...
// This is equivalent to twenty-first's ZerofierTree::new_from_domain().
...
// This is equivalent to twenty-first's Leaf::new().
...
// This is equivalent to twenty-first's Branch::new().
...
// This is equivalent to twenty-first's ZerofierTree::zerofier().
