...
// This package implements the Tip5 hash function, equivalent to twenty-first's Tip5.
//
// Tip5 is an arithmetization-oriented hash function designed for recursive STARKs.
// Reference: https://eprint.iacr.org/2023/107.pdf
// Implementation reference: https://github.com/Neptune-Crypto/twenty-first
package hash
...
// Tip5 constants - equivalent to twenty-first's constants
const (
	StateSize         = 16
	NumSplitAndLookup = 4
	Log2StateSize     = 4
...
// This is equivalent to twenty-first's Tip5 struct.
type Tip5 struct {
	state [StateSize]field.Element
}

// LookupTable is the lookup table used in Tip5 permutation.
// This is equivalent to twenty-first's LOOKUP_TABLE.
...
// This is equivalent to twenty-first's ROUND_CONSTANTS.
...
// This is equivalent to twenty-first's Tip5::new()
...
// This is equivalent to twenty-first's Tip5::permutation()
...
// This is equivalent to twenty-first's Tip5::round()
...
// This is equivalent to twenty-first's Tip5::sbox_layer()
...
// This is equivalent to twenty-first's Tip5::split_and_lookup()
...
// This is equivalent to twenty-first's Tip5::mds_generated()
...
// This is equivalent to twenty-first's Tip5::hash_10()
...
// This is equivalent to twenty-first's Tip5::hash_pair()
...
// This is equivalent to twenty-first's Tip5::hash_varlen()
...
// This is equivalent to twenty-first's Sponge::pad_and_absorb_all()
