...
- **Email**: security@proteus-crypto.org
...
Kraken-Crypt implements several security measures:
...
- **Security Team**: security@proteus-crypto.org
- **General Inquiries**: info@proteus-crypto.org
- **GitHub Security**: Use GitHub's private vulnerability reporting

## Acknowledgments

We thank the security researchers and community members who help us maintain the security of Kraken-Crypt.
